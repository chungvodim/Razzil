...
(
	...
	CONSTRAINT FK_Step_User FOREIGN KEY([CreatedByUserID]) REFERENCES UserRole([Id]),
	CONSTRAINT FK_Step_User_1 FOREIGN KEY([LastUpdatedByUserID]) REFERENCES UserRole([Id]),
