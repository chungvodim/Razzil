...
namespace Razzil.Web.Controllers
{
    public class BankTransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TransactionId,TypeId,FromAccountNumber,FromBankId,ToAccountNumber,ToBankId,Amount,BankCharge,Otp,OtpRef,LastPage,CreatedTime,LastUpdatedTime,UserName,Password,FromAccountName,ToAccountName,Content,Captcha,Balance,Active,CreatedByUserID,LastUpdatedByUserID")] BankTransaction bankTransaction)
        {
